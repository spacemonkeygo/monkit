...
{{% aligncenter %}}
{{< jtfig src="/images/monv2/callgraph2.png" width="750" >}}
{{%/ aligncenter %}}
...
{{% aligncenter %}}
{{< figure src="/images/monv2/trace.png" >}}
{{%/ aligncenter %}}
...
{{% aligncenter %}}
{{< figure src="/images/monv2/handlehttp.png" >}}
{{%/ aligncenter %}}
...
{{% aligncenter %}}
{{< jtfig src="/images/monv2/trace.svg" width="750" >}}
{{%/ aligncenter %}}
